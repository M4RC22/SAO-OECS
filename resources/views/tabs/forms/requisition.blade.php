...
<div class="container">
    ...
    <div class="container shadow p-3 mb-5 bg-#fff rounded mt-3">
        ...
        <form action="{{ route('requisition') }}" id="reqForms">
            ...
            <div class="row g-3">
                <div class="form-group col-md-3 ">
                    ...
                    <input type="text" class="form-control" id="controlNum" >
                </div>

                <div class="form-group col-md-3">
                    <label for="dateFiled" class="form-label">Date Filed</label>
                    <input type="date" class="form-control" id="dateFiled" value="<?php echo date('Y-m-d'); ?>">
                </div>

                <div class="form-group col-md-3">
                    <label for="dateNeeded" class="form-label">Date Needed</label>
                    <input type="date" class="form-control" id="dateNeeded" value="<?php echo date('Y-m-d'); ?>">
                </div>
            ...
            <div class="row g-3">
                <div class="form-group form-floating col-md-12">
                    ...
                    <textarea class="form-control" id="remarks" style="height: 150px" ></textarea>
                </div>


                <div class="form-group col-md-4 ">
                    <label for="" class="form-label">Charge to</label>
                    <input type="text" class="form-control" id="primaryNum" placeholder="Department/Unit" >
                </div>
